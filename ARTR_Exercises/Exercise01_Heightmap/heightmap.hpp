...
private:
    ...
    {
        //Hier soll das Newell-Verfahren für eine beliebig lange Liste aus Input-Vertices implementiert werden.
        //Als Ergebnis wird eine normalisierte Normale des Typs QVector3D zurückgegeben.
